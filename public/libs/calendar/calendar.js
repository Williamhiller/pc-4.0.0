    ...
    Calendar.prototype = {
        ...
        getDayItem: function(y, m, d, f) {
            ...
            if (markData) {
                ...
                var MARK_DAY_HTML = '<p>'+ d+'</p>' +
                    '<p class="price">'+ $item.data(MARK_DATA).price+'</p>' +
                    '<p class="num">'+ $item.data(MARK_DATA).num+'</p>' +
                    '<p class="original-price" style="display: none">' + $item.data(MARK_DATA).ori+'</p>';
                $item.html( MARK_DAY_HTML );
                $item.addClass('ops')
            }
